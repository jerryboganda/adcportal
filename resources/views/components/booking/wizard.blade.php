    ...
    <div class="form-wizard">
        <div class="steps">
            <ul>
                ...
                @if (false || false)
                    <li class="steps_status" id="onlineAppointmentStep" style="display: none;"></li>
                @endif
        ...
        <div class="myContainer">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="password"
                                                    id="new-user-password" placeholder="Your Password">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="referred_by"
                                                    id="new-user-referred_by" placeholder="{{ __('Doctor Name (Optional)') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label>{{ __('Password') }}</label>
                                                <input type="password" class="form-control" name="password"
                                                    id="existing-user-password" placeholder="Your Password">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label>{{ __('Referred By') }}</label>
                                                <input type="text" class="form-control" name="referred_by"
                                                    id="existing-user-referred_by" placeholder="{{ __('Doctor Name (Optional)') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <label>{{ __('Referred By') }}</label>
                                                <input type="text" class="form-control" name="referred_by"
                                                    id="guest-user-referred_by" placeholder="{{ __('Doctor Name (Optional)') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="step-container" id="final_step">
                <div class="appointment-wrp">
                    ...
                    <div class="step-btns">
                        @stack('iCal_exports')
                        <a href="{{ route('appointments.form') }}#appointment"
