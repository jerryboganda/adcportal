...
cd /d "D:\Projects\Radiology Information System"
...
"C:\Program Files\Git\bin\bash.exe" -c "cd '/d/Projects/Radiology Information System' && bash scripts/dev-tunnel.sh start"

echo [2/4] Storage sync (uploads + storage/app, ~2s cadence)...
"C:\Program Files\Git\bin\bash.exe" -c "cd '/d/Projects/Radiology Information System' && bash scripts/dev-storage-sync.sh start"

echo [3/4] Laravel API on http://127.0.0.1:8000 ...
