...
class User extends Authenticatable implements LaratrustUser,MustVerifyEmail
{
    ...
    public static function CompanySetting($id = null,$businee_id = null)
    {
        ...
        $company_setting = [
            ...
            "title_text" => !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : "PolytronX - RIS",
            "footer_text" => !empty($admin_settings['footer_text']) ? $admin_settings['footer_text'] :"Copyright © PolytronX - RIS | Powered By PolytronX - Business Digitalized",
