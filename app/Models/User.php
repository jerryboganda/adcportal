...
class User extends Authenticatable implements LaratrustUser,MustVerifyEmail,JWTSubject
{
    ...
    public static function CompanySetting($id = null,$businee_id = null)
    {
        ...
        $company_setting = [
            ...
            "title_text" => !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : "ADC Patient Management",
            "footer_text" => !empty($admin_settings['footer_text']) ? $admin_settings['footer_text'] :"Copyright © ADC",
