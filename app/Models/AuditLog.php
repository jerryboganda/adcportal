...
class AuditLog extends Model
{
    ...
    public const PLATFORM_ACTIONS = [
        ...
        'tenant_deployment_updated', 'tenant_branding_updated',
        'tenant_domain_added', 'tenant_domain_removed', 'tenant_domain_updated', 'tenant_domain_verified',
